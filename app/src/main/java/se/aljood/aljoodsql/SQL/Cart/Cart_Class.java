...
public class Cart_Class{
    ...
    float avg_rating;
    Double cart_qty,item_quantity,discount_qty,discount_price,item_price,item_tax_rate_value,item_weight,item_point_pris,special_price;
    ...
    public void setCart_qty(Double cart_qty) {
